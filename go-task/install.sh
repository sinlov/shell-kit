...
Usage: $this [-b] bindir [-d] [tag] -x [proxy]
  -b sets bindir or installation directory, Defaults to ./bin
  -x sets proxy prefix at download
...
if [ ! -n "${DOWNLOAD_PROXY_PREFIX}" ]; then
  log_debug "add proxy prefix to download url as: ${DOWNLOAD_PROXY_PREFIX}"
  TARBALL_URL=${DOWNLOAD_PROXY_PREFIX}${TARBALL_URL}
  CHECKSUM_URL=${DOWNLOAD_PROXY_PREFIX}${CHECKSUM_URL}
fi
